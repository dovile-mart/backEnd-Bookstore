...
//public class BookstoreApplication {
	...
	// Your code...add some demo data to db
		...
		AppUser user1 = new AppUser("user", "$2a$10$mR2WmGjLXN3t6v.cjNWY8upoHecRvcGjmq7slGq.9wwY83BD3yJkK", "USER");
		AppUser user2 = new AppUser("admin", "$2a$10$jzx/BIs9sqsRfAaJOeGWeuqFbH/GG4Uxuz82ysgG5gn0ygew53GuW", "ADMIN");
